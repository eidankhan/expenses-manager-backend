...
public class IncomeService {
    ...
    public IncomeService(){
        ...
        String[] headers = {"ID", "Date", "Amount", "Payer", "Description"};
        String[] row = {"1", currentDate.toString(), "54800", "Teresol", "Payment received for the month of November"};
        CSVFileWriter.writeToCSVFile(headers, row, filePath);
